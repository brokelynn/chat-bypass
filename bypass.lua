...
local bypasses = {
    ...
    ["dick"] = bypass("dick"),
    ["pussy"] = bypass("pussy"),
    ["retard"] = bypass("retard"),
    ["whore"] = bypass("whore"),
    ["slut"] = bypass("slut"),
    ["dumbfuck"] = bypass("dumbfuck"),
    ["bad"] = bypass("bad"),
    ["kill"] = bypass("kill"),
    ["gay"] = bypass("gay"),
    ["gayass"] = bypass("gayass"),
    ["lesbian"] = bypass("lesbain"),
    ["fucker"] = bypass("fucker"),
    ["retarded"] = bypass("retarded"),
    ["dickhead"] = bypass("dickhead"),
    ["boobs"] = bypass("boobs"),
    ["weed"] = bypass("weed"),
    ["cum"] = bypass("cum"),
    ["squirt"] = bypass("squirt"),
    ["rape"] = bypass("rape"),
    ["sex"] = bypass("sex"),
    ["anal"] = bypass("anal"),
    ["dumbass"] = bypass("dumbass"),
    ["asshole"] = bypass("asshole"),
    ["fucked"] = bypass("fucked"),
    ["assed"] = bypass("assed"),
